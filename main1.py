# main_with_web.py - Modified version of your main.py with web interface integration
...
# Import the new web interface
from web_interface import integrate_web_interface, start_web_services, update_web_interface

class HyperliquidMarketMaker:
    def __init__(self):
        print("🚀 Initializing Hyperliquid Market Maker with Web Interface...")
        ...
        # NEW: Initialize web interface
        self.web_interface, self.dashboard_server = integrate_web_interface(self)
    ...
    def handle_real_time_orderbook(self, orderbook: Dict):
        ...
        if orderbook:
            ...
            update_web_interface(self, market_data={
    ...
    async def initialize(self):
        ...
        update_web_interface(self, bot_status='INITIALIZING')
        ...
        # Start web services as a background task
        asyncio.create_task(start_web_services(self))
        ...
        # Update web interface status
        update_web_interface(self, bot_status='ACTIVE')
    ...
    async def cleanup(self):
        ...
        update_web_interface(self, bot_status='STOPPING')
    ...
    async def update_positions_and_orders(self):
        ...
        try:
            ...
            if account_info:
                ...
                # Update web interface with account data
                ...
                update_web_interface(self, account_data={
            ...
            if open_orders is not None:
                ...
                # Update web interface with orders
                update_web_interface(self, orders=open_orders)
            else:
    ...
    async def execute_trading_logic(self, orderbook: Dict):
        ...
        try:
            ...
            # Update web interface with microstructure data
            update_web_interface(self, microstructure=signals)
            ...
            analysis = self.web_interface.generate_analysis_text(signals, position, orderbook, current_orders)
            update_web_interface(self, analysis=analysis)
            ...
            if current_order_count < max_total_orders:
                ...
                if new_orders:
                    ...
                    # Update web interface with new orders
                    updated_orders = list(self.position_tracker.open_orders.values())
                    orders_for_web = []
                    for order in updated_orders:
                        orders_for_web.append({
                            'oid': order.order_id,
                            'coin': order.symbol,
                            'side': order.side,
                            'sz': str(order.size),
                    ...
                    update_web_interface(self, orders=orders_for_web)
                else:
...
if __name__ == "__main__":
    print("🚀 HYPERLIQUID MARKET MAKER WITH WEB INTERFACE")
    print("=" * 60)
    ...
    print(f"🌐 Web dashboard: http://localhost:8000/dashboard.html")
